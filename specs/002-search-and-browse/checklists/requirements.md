...
- This spec was split out of the original combined `001-asaar-baseline` spec so the search/
  browse domain can be modified independently of catalog, deals, accounts, scraping, and
