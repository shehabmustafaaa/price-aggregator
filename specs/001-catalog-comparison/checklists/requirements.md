# Specification Quality Checklist: Catalog & Price Comparison
...
- This spec was split out of the original combined `001-asaar-baseline` spec so the catalog/
  comparison domain can be modified independently of search, deals, accounts, scraping, and
